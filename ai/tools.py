    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "(SOURCE_ID, SOURCE_DESCRIPTION), ПОЛНЫЕ UTM-метки и поле "
                "UF_CRM_1723465843 — «причина отказа» (свободный текст менеджера, "
                "заполняется для JUNK-лидов). "
        ...
        },
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "title_contains": {
                        "type": "string",
                        "description": "Опциональный substring-поиск в TITLE (например для фильтра по продукту или телефонному пулу)."
                    },
                    "top_n": {
                        "type": "integer",
